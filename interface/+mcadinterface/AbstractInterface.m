    ...
    methods(Access=private)
        ...
        function getMcadParameters(obj)
            ...
            for idxParam = 1:length(obj.McadParameterNameList)
                ...
                if success ~= 0
                    warning("Failed to retrieve parameter '" + paramName + "' using the 'GetVariable' ActiveX command. " + newline + ...
                        "Check if your Motor-CAD version is compatible with this version of the import tool. " + newline + ...
                        "Check that the Motor-CAD ActiveX automation is correctly set up." + newline + ...
                        "Learn more in the <a href=""https://www.mathworks.com/matlabcentral/fileexchange/120598-import-a-motor-cad-thermal-model-into-simulink-and-simscape"">" + ...
                        "MATLAB File Exchange Page</a> for the 'Import a Motor-CAD Thermal Model into Simulink and Simscape' tool." ...
                        );
                    paramValue = NaN;
                end
                obj.McadParameterValuesList{idxParam} = paramValue;
